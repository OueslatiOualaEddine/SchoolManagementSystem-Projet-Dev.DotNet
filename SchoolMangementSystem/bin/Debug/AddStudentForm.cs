...
namespace SchoolMangementSystem
{
    ...
    {
        SqlConnection connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\DELL\Documents\School.mdf;Integrated Security=True;Connect Timeout=30");
                    ...
                    try
                    {
                        ...
                        using (SqlCommand checkSID = new SqlCommand(checkStudentID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\DELL\Desktop\Projet en cours\Projet Dot Net\SchoolMangementSystem\SchoolMangementSystem\Student_Directory\", student_id.Text.Trim() + ".jpg");
