                    ...
                    try
                    {
                        ...
                        using(SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string path = Path.Combine(@"C:\Users\DELL\Desktop\Projet en cours\Projet Dot Net\SchoolMangementSystem\SchoolMangementSystem\Teacher_Directory\", teacher_id.Text.Trim() + ".jpg");
